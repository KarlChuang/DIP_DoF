...
parser.add_argument('--final_test_batch_size', type = int, default = 32, help = 'Batch size for test.')
...
# Plot
parser.add_argument('--plot_csv', type = str, default = '', help = 'Save training plot csv file') 
